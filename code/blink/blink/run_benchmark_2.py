...
PARAMETERS = {
    ...
    #"biencoder_model":"zel_everything/ZEL/code/blink/blink/trained_models/25percent/epoch_0/pytorch_model.bin",
    "biencoder_config": "models/biencoder_wiki_large.json",
    # "biencoder_config":"zel_everything/ZEL/code/blink/blink/trained_models/25percent/epoch_0/config.json",
    #"biencoder_config":"zel_everything/ZEL/code/blink/blink/trained_models/training_params_old.json",
    ...
    #"entity_encoding":"zel_everything/ZEL/code/blink/blink/trained_models/25percent/epoch_0/tiny.t7",
